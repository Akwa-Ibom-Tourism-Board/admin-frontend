...
const Overview = () => {
  ...
  const { data: analyticsData, isLoading: analyticsLoading } =
    useGetEstablishmentsAnalyticsData();
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      setStats({
        totalEntities: analyticsData?.data?.totalEntities,
        hotels: analyticsData?.data?.totalHotels,
        restaurants: analyticsData?.data?.totalRestaurants,
        bars: analyticsData?.data?.totalBarsAndLounges,
        registrationsThisMonth:
          analyticsData?.data?.totalRegistrationsThisMonth,
        topLocalGovernment:
          analyticsData?.data?.topLocalGovernmentRegistered?.localGovernment,
      });
    };
